#!/usr/bin/env python3
"""
SWE Runner with Curie Trajectory Format

A runner that uses Curie-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Curie-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Curie-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Curie format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Curie-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Curie-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Curie Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Curie-Agent's built-in execution environments
    and outputs trajectories in Curie-Agent format.
    """
    ...
    def _convert_to_curie_format(
        ...
        """
        Convert internal message format to Curie trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Curie trajectory format
        trajectory = self._convert_to_curie_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Curie trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Curie Trajectory Format")
    print("=" * 60)

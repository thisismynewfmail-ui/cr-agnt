...
Built for [Curie Agent](https://github.com/thisismynewfmail-ui/Cur-Agnt). Usable in any coding agent. Canonical source lives here; synced to [`thisismynewfmail-ui/Cur-Agnt/skills/creative/ascii-video`](https://github.com/thisismynewfmail-ui/Cur-Agnt/tree/main/skills/creative/ascii-video) via PR.

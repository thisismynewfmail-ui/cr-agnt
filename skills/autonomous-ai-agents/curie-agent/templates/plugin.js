/**
 * Curie desktop plugin template. Save as:
 *   <curie home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <curie home> is ~/.curie by default, or ~/.curie/profiles/<name>
 * when running a named profile (`curie -p <name>`). Run `curie doctor` (or
 ...
 * Only these imports resolve: @curie/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@curie/plugin-sdk'

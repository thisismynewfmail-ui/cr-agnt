...
Registry of record: `curie_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Curie config+state snapshots (CLI)

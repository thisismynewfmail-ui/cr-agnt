...
def _state_dir() -> Path:
    ...
    # Default: $CURIE_HOME/watcher-state/, falling back to ~/.curie/watcher-state/.
    curie_home = os.environ.get("CURIE_HOME") or str(Path.home() / ".curie")
    return Path(curie_home) / "watcher-state"

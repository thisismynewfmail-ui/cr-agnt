...
Data file: $CURIE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CURIE_HOME = Path(os.environ.get("CURIE_HOME", Path.home() / ".curie"))
DATA_DIR = _CURIE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

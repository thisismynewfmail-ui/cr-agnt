# nix/overlays.nix — Expose pkgs.curie-agent for external NixOS configs
#
...
# `pkgs.curie-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    curie-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}

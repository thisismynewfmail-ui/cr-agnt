      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via CURIE_BUNDLED_SKILLS /
            # CURIE_OPTIONAL_SKILLS (see curie-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + CURIE_BUNDLED_LOCALES
            # / CURIE_OPTIONAL_MCPS, not via the wheel. Excluding them

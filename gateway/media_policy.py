...
from environment variables:
  ...
  - ``CURIE_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``CURIE_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``CURIE_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``curie cron run`` in the CLI, ``curie send``, a
...
_STRICT_ENV = "CURIE_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "CURIE_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "CURIE_MEDIA_TRUST_RECENT_FILES"

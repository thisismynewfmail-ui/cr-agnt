...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$CURIE_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_curie_dir("platforms/whatsapp/session", "whatsapp/session")

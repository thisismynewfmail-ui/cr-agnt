...
Hooks are discovered from ~/.curie/hooks/ directories, each containing:
...
HOOKS_DIR = get_curie_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"curie_hook_{hook_name}"

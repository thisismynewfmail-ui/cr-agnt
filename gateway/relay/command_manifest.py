...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Curie session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Curie session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Curie agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Curie Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Curie gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Curie session in it",

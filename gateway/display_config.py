...
# Other display settings (compact, skin, etc.) are CLI-only
...
_PLATFORM_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    # "new"/"all" spam permanent lines in channels (curie-agent#14663).
    "slack":           {
        **_TIER_MEDIUM,
        "tool_progress": "off",
        "long_running_notifications": False,
    ...
    # Curie Cloud adapter doesn't implement edit_message yet, so we

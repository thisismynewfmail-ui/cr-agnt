 ...
 *
 * Symptom: in `curie --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@curie/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using curie --tui and as i type multiline my caret at the end will often ' +

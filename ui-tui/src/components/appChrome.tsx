import { Box, type ScrollBoxHandle, stringWidth, Text } from '@curie/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (CURIE_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (CURIE_DEV_CREDITS), lowest priority,

...
import type { ScrollBoxHandle } from '@curie/ink'
import { evictInkCaches } from '@curie/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CURIE_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }

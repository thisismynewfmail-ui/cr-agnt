import type { BillingBlock, UsageModelData } from '@curie/shared/billing'
import type { CurieSkin } from '@curie/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@curie/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = CurieSkin
...
// Wire shapes now live in @curie/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,

...
await build({
  ...
  // Skip the prebuilt @curie/ink bundle and inline the source instead:
  ...
  alias: { '@curie/ink': resolve(root, 'packages/curie-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The curie_cli launcher

 ...
 * across theme x background scenes to <tmpdir>/curie-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@curie/ink'
...
// The regenerated slate light_colors block from curie_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/curie-agent',
...
const setup = (bgHex: string) => {
  process.env.CURIE_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}

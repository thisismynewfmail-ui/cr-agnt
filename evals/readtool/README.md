...
benchmarked ten harnesses on hostile-file handling — and whose Curie column
...
Every task runs the full Curie agent (file + terminal + search toolsets)
...
Rules of engagement (from curiebench discipline):

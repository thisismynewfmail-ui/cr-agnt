...
The run gets a throwaway CURIE_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE CURIE_HOME is redirected to the

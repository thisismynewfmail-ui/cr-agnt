#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Curie logs.
...
With no LOGFILE, reads ``$CURIE_HOME/logs/agent.log`` (default ~/.curie).
...
def default_log() -> Path:
    home = os.environ.get("CURIE_HOME") or str(Path.home() / ".curie")

#!/usr/bin/env python3
"""Build the Curie Skills Index — a centralized JSON catalog of all skills.
...
`curie skills search/install` can use it without hitting the GitHub API.
...
# Ensure CURIE_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Curie Skills Index...", flush=True)

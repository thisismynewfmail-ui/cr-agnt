#!/usr/bin/env python3
"""Build the Curie Model Catalog — a centralized JSON manifest of curated models.
...
Curie CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Curie release.
...
# Ensure CURIE_HOME is set for imports that touch it at module level.
os.environ.setdefault("CURIE_HOME", os.path.join(os.path.expanduser("~"), ".curie"))

from curie_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "curie-agent repo",
            "docs": "https://github.com/thisismynewfmail-ui/Cur-Agnt/blob/main/website/docs/reference/model-catalog.md",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Curie '

...
def main() -> None:
    ...
    curie_home = Path(tempfile.mkdtemp(prefix="curie-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "curie-gateway-smoke",
    ...
    print(json.dumps({"curie_home": str(curie_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))

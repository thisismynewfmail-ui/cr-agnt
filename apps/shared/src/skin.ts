/**
 * Canonical Curie skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$CURIE_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`curie_cli/skin_engine.py`),
 ...
 *   • CLI     → `curie_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *

...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\curie\curie-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@curie/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@curie/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@curie/shared': path.resolve(__dirname, '../shared/src'),

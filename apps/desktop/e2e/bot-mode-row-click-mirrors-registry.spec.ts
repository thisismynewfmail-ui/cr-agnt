...
async function seedBot(curieHome: string, mockUrl: string, name: string): Promise<void> {
  const dir = path.join(curieHome, 'profiles', name)
...
test.beforeAll(async () => {
  ...
  await seedBot(sandbox.curieHome, mock.url, 'alpha')
  await seedBot(sandbox.curieHome, mock.url, 'beta')

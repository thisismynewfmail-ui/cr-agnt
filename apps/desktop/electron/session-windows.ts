...
// by main.ts (`setBackgroundThrottling` driven by the merged `curie:active-work`
...
// (the "Curie idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Curie" wake word has NO preceding click,

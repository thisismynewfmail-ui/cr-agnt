 ...
 * startCurie() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startCurie() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startCurie`, re-emits

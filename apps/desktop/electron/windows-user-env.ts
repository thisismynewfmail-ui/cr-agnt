...
// even though a fresh shell — and the Curie CLI — sees it immediately. The
// desktop's CURIE_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\curie. Reading
...
//       CURIE_HOME    REG_SZ    F:\Curie\data
//

...
cd apps/desktop
XCURSOR_SIZE=24 CURIE_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/curie-typing
# → /tmp/curie-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/curie-typing.before.heapsnapshot
# → /tmp/curie-typing.after.heapsnapshot
```

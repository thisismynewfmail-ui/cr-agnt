...
// (#73044). Exercises the REAL curie + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/curie')
...
const conn = (over: Partial<CurieConnection> = {}): CurieConnection =>
  ({
    authMode: 'oauth',

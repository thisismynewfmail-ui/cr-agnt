...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@curie/plugin-sdk'
 ...
 *  (curie-agent#90102) and are discarded. Without `canonical_session` (older

...
import type { CuriePlugin, PaletteContribution } from '@curie/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@curie/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: CuriePlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:

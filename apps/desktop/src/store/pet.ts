...
export interface PetInfo {
  ...
  // the Curie "run" activity state uses the in-place running row).
 ...
 * CURIE_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'curie.desktop.pet-roam.v1'

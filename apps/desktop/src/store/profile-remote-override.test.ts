...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://curie.example.com:8443/x')).toBe('curie.example.com:8443')
    expect(remoteHostLabel('https://curie.example.com:443')).toBe('curie.example.com')
    expect(remoteHostLabel('http://curie.example.com:80')).toBe('curie.example.com')
  })

...
const POPOUT_STORAGE_KEY = 'curie.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'curie.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'curie.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'curie.desktop.composerPopout.position'

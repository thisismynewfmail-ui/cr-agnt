...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('curie.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('curie.desktop.unreadFinishedSessions')

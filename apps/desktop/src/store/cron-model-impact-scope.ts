...
function identityForConnection(connection: CurieConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: CurieConnection | null): void {

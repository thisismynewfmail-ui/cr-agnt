...
function installBridge(
  openSessionWindow?: Window['curieDesktop']['openSessionWindow'],
  openWindow?: Window['curieDesktop']['openWindow'],
  openBrowserWindow?: Window['curieDesktop']['openBrowserWindow']
) {

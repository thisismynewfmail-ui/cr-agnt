...
const STORAGE_KEY = 'curie.desktop.layoutTree.v2'

writeKey('curie.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('curie.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('curie.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'curie.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'curie.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'curie.desktop.hiddenStripTabs.v1'
...
writeKey('curie.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__CURIE_LAYOUT_TREE__ = {
    close: closeTreePane,

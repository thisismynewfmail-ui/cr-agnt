 ...
 * plugins resolve `@curie/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __CURIE_PLUGIN_SDK__: sdk,
  __CURIE_REACT__: React,
  __CURIE_REACT_JSX__: jsxRuntime,
  __CURIE_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@curie/plugin-sdk': shimUrl('__CURIE_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__CURIE_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__CURIE_REACT_JSX__'),
    react: shimUrl('__CURIE_REACT__')
  }

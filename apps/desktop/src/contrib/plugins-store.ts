 ...
 * `<curie home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'curie.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'curie.desktop.disabledPlugins.v1'

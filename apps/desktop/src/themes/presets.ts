...
/**
 * Nous — the canonical Curie desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Curie's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Curie desktop identity: GitHub's chrome carrying Nous

/**
 * Curie skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$CURIE_HOME/skins/` (or a
 * built-in) resolved by `curie_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Curie authors from a prompt lights up all three surfaces from one file.
 *
...
import type { CurieSkin, SkinColors } from '@curie/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: CurieSkin): DesktopTheme | null {

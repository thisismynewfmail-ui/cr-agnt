...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|curie):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.curieDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.curieDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Curie, and it is the surface the agent

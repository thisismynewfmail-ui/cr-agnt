...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/curie-agent')).toBe('~/www/curie-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/curie-agent')).toBe('curie-agent')
    expect(pathLeaf('~/www/curie-agent')).toBe('curie-agent')

...
import type { ModelOptionsResponse, SessionInfo } from '@/types/curie'
 ...
 *
 * Only the leading status prefix (e.g. "Curie is thinking...") and the
 ...
 *  resolved comment as JSON (CuriePrComment shape); a malformed payload falls

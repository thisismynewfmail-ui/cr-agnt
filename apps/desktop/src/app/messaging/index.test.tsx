...
import type { MessagingPlatformInfo } from '@/types/curie'
...
describe('MessagingView setup-guide link', () => {
  ...
  it('opens a real docs URL through the validated external opener', async () => {
    const docsUrl = 'https://github.com/thisismynewfmail-ui/Cur-Agnt/blob/main/website/docs/user-guide/messaging/teams.md'

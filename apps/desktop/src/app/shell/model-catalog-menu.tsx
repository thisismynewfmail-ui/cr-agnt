...
import { getLocalModelsStatus } from '@/curie'
...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelOptionsResponse } from '@/types/curie'
 ...
 * Returning `{}` is fine — the row then shows Curie' defaults.
 */

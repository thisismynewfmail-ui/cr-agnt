...
const TAKEOVER_KEY = 'curie.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Curie can't clear via the API — the user
 *  sees exactly what runs instead of Curie silently deleting their creds. */

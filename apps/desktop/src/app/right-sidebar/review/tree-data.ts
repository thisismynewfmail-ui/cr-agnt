import type { CurieReviewFile } from '@/global'
...
export function buildReviewFlatList(files: CurieReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: CurieReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')

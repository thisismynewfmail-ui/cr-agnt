...
import { getLatestSessionMessages, type ProfileScope } from '@/curie'
...
interface BackgroundSyncParams {
  ...
  refreshCurieConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshCurieConfig])
}

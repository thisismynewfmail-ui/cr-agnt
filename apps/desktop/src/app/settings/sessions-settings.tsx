...
import type { CurieConfigRecord, SessionInfo } from '@/types/curie'
...
// / Program Files), which buried any files Curie wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.curieDesktop` is
    ...
    const settings = window.curieDesktop?.settings

...
import { getCurieConfigRecord, listAllProfileSessions } from '@/curie'
...
// Curie session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const baseGroups = useMemo<PaletteGroup[]>(() => {
    ...
    // exact ties are the common case — "unlock" hits both "Toggle unlock" and a
    // worktree named bb/unlock-* as a whole word. So this order IS the priority:
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-curie',
            keywords: ['update', 'upgrade', 'curie', 'version', 'system', 'restart'],
            label: cc.updateCurie,

...
const FOCUS_EVENT = 'curie:composer-focus'
const INSERT_EVENT = 'curie:composer-insert'
const ATTACH_IMAGES_EVENT = 'curie:composer-attach-images'
const INSERT_REFS_EVENT = 'curie:composer-insert-refs'
const SUBMIT_EVENT = 'curie:composer-submit'
const VOICE_TOGGLE_EVENT = 'curie:composer-voice-toggle'
const MODEL_MENU_EVENT = 'curie:composer-model-menu'

...
import type { CurieGitBranch } from '@/global'
...
const branchActionLabel = (branch: CurieGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<CurieGitBranch[]>([])
  ...
  const convert = async (branch: CurieGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }

...
import type { ProjectInfo, SessionInfo } from '@/curie'
 ...
 * repo shows its branches/worktrees even when they have no Curie sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: CurieGitWorktree[]
): SidebarSessionGroup[] {

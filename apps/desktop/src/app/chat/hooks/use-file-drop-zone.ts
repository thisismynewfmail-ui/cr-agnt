...
import { type DroppedFile, extractDroppedFiles, CURIE_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, CURIE_PATHS_MIME) ? 'files' : null

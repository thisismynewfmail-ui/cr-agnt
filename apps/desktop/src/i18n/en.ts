...
export const en: Translations = {
  ...
  boot: {
    ready: 'Curie Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Curie settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Curie backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingCurieDesktop: 'Starting Curie Desktop…'
    },
    errors: {
      backgroundExited: 'Curie background process exited.',
      backgroundExitedDuringStartup: 'Curie background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Curie backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateCurie: 'Update Curie',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Curie Desktop.',
    ...
    native: {
      ...
      inputBody: 'Curie is waiting for your response.',
      turnDoneTitle: 'Curie finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `curie debug share --nous` from a terminal, or `curie debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Curie defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Curie backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Curie backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.curie/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Curie is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Curie asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Curie was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Curie was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Curie follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Curie can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Curie when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Curie walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Curie is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Curie, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Curie Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Curie runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Curie only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Curie',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Curie checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Curie configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Curie.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Curie gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Curie Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Curie Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Curie runtime managed by this app.',
      kindRemoteDesc: 'A Curie gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Curie Cloud account.',
      kindSshDesc: 'A Curie install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Curie manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Curie Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Curie backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset CURIE_DESKTOP_REMOTE_URL and CURIE_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Curie backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Curie backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Curie Cloud',
      cloudDesc: 'Sign in once to Curie Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Curie Cloud',
      cloudSignIn: 'Sign in to Curie Cloud',
      cloudSignedIn: 'Signed in to Curie Cloud',
      cloudNeedsSignIn: 'Sign in to Curie Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Curie Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Curie Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Curie Cloud',
      cloudSignedOutMessage: 'Cleared the Curie Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /curie.',
      ...
      restartingMessage: 'Curie Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Curie ${version}` : ''}`,
      ...
      sshDesc:
        'Curie is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshCuriePathTitle: 'Curie path (optional)',
      sshCuriePathDesc: 'Full path to the remote curie binary. Blank = auto-detect.',
      sshCuriePathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Curie found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Curie runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update Curie on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Curie. Review the exact configuration below — it comes from the link, not from Curie.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Curie starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Curie ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Curie runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Curie at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Curie browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via curie curator restore.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Curie builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Curie to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Curie to generate pets.',
      backgroundHint: 'You can close this — Curie will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Curie desktop' },
    ...
    curieActiveSessions: (version, count) => `Curie ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@curie:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Curie you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://curie.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Curie environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Curie did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Curie will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Curie backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Curie. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Curie backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Curie...',
    placeholderReconnecting: 'Reconnecting to Curie…',
    ...
    attachUrlDesc: 'Curie will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Curie to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Curie…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Curie…',
    ...
    unsupportedMessage: 'This version of Curie can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Curie from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Curie will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Curie desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Curie updater takes over in its own window and reopens Curie automatically when it’s done. Please don’t reopen Curie yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Curie reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Curie reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Curie?',
    blockerBody:
      'Curie needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Curie',
    foreignBlockerBody:
      'Curie can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Curie can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Curie needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Curie Desktop',
    setupChoiceDesc:
      'Connect this app to a Curie gateway you already run, or install Curie locally on this computer.',
    connectExistingTitle: 'Connect to existing Curie',
    ...
    installLocalTitle: 'Install Curie locally',
    installLocalDesc: 'Download Curie, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Curie Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Curie',
    remoteSetupDesc: 'Enter your gateway URL. Curie Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Curie gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/curie',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Curie gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Curie Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Curie CLI or desktop instance is running. Stop any running Curie instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Curie Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Curie is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Curie…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Curie',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Curie at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Curie connects automatically',
    ...
    authorizeThere: 'Authorize Curie there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Curie there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Curie Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Curie Cloud · ${host}`,
      ...
      session: 'Session',
      unlockOn: 'UNLOCK on — auto-approving dangerous commands. Shift+click toggles globally.',
      unlockOff: 'UNLOCK off. Shift+click toggles globally.',
      modelNone: 'none',
      noModel: 'no model',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Curie will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Curie is restarting...',
      askRestart: 'Ask Curie to restart the server',
      lookingRestart: taskId => `Curie is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Curie is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Curie to open a page.',
      finishedRestarting: message => `Curie finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Curie could not restart the server.',
      stillWorking:
        'Curie is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Curie is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Curie gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.curie/config.yaml). Curie won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Curie needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Curie needs a credential to continue.',
  ...
  desktop: {
    ...
    unlockArmed: 'UNLOCK armed for this chat',
    unlockOff: 'UNLOCK off',
    unlockSystem: active => `UNLOCK ${active ? 'on' : 'off'} for this session`,
    unlockTitle: 'UNLOCK',
    unlockToggleFailed: 'Could not toggle UNLOCK',
    ...
    restartToUseSaveImage: 'Restart Curie Desktop to use Save Image.',
    restartToSaveImages: 'Restart Curie Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `curie gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Curie loads when the work calls for them.'
      },
      messaging: {
        title: 'Curie away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Curie made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Curie — own keys, own memory, own sessions.'
      },
      'composer-mentions': {

...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshCuriePathTitle: string
      sshCuriePathDesc: string
      sshCuriePathPlaceholder: string
  ...
  commandCenter: {
    ...
    curieActiveSessions: (version: string, count: number) => string
  ...
  desktop: {
    ...
    unlockArmed: string
    unlockOff: string
    unlockSystem: (active: boolean) => string
    unlockTitle: string
    unlockToggleFailed: string

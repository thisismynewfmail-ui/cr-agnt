...
export const ja = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'リモートホストに Curie がインストールされていません。リモートでインストールする（curl -fsSL https://raw.githubusercontent.com/thisismynewfmail-ui/cru/main/scripts/install.sh | sh）か、Curie パスを設定してください。',
      sshErrPlatform:

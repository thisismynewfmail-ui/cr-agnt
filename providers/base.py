...
def _profile_user_agent() -> str:
    """Return a ``curie-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from curie_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"curie-cli/{_ver}"
    except Exception:
        return "curie-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # curie-cli UA so the catalog endpoint is reachable.

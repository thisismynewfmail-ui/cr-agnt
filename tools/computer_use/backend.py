...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of thisismynewfmail-ui/Cur-Agnt#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of thisismynewfmail-ui/Cur-Agnt#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (thisismynewfmail-ui/Cur-Agnt#67052). ``ok`` stays

#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the Curie desktop GUI.
...
def read_preview_tool(
    ...
    if callback is None:
        return tool_error("read_preview is only available in the Curie desktop app.")
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "Curie desktop GUI (the pane open_preview opens beside this chat). Call "

...
Only included in the curie-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Curie-Agent (https://github.com/thisismynewfmail-ui/Cur-Agnt)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_curie_home() / "cache" / "discord_capabilities.json"

"""Core NeMo Relay adapter for Curie tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Curie tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Curie Relay tool execution cannot run on an active event-loop thread"
    )

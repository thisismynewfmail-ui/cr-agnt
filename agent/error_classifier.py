...
# ``data:`` field before Curie receives a completion chunk.  Keeping this
...
# See: https://github.com/thisismynewfmail-ui/Cur-Agnt/issues/69078
...
#
# See: https://github.com/thisismynewfmail-ui/Cur-Agnt/issues/27344
...
# case: a stream dies mid-response and Curie persists a content-less
...
# Request parameters that Curie sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # curie_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from curie_cli.plugins import get_plugin_error_classification

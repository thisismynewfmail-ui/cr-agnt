 ...
 * `window.__CURIE_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Curie brand in the top bar
 ...
 *  `window.__CURIE_PLUGINS__.registerSlot(...)`.
 *

 ...
 *
 * Plugins call window.__CURIE_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__CURIE_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__CURIE_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__CURIE_PLUGIN_SDK__ = {
    ...
    // window.__CURIE_SESSION_TOKEN__ directly.
    authedFetch,

/**
 * Curie Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__CURIE_PLUGIN_SDK__`` and
 * ``window.__CURIE_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__CURIE_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``CuriePluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@curie/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__CURIE_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__CURIE_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__CURIE_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface CuriePluginSDK {
...
declare global {
  interface Window {
    __CURIE_PLUGIN_SDK__?: CuriePluginSDK;
    __CURIE_PLUGINS__?: PluginRegistry;
  }
}

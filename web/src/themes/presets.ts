 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `curie_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Curie Teal",
  description: "Classic dark teal — the canonical Curie look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Curie Teal (Large)",
  description: "Curie Teal with bigger fonts and roomier spacing",

...
const STORAGE_KEY = "curie-dashboard-theme";
...
const FONT_STORAGE_KEY = "curie-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `curie_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "curie-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-curie-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-curie-theme-font", "true");

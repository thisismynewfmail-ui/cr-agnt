 ...
 *
 * Values mirror curie_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Curie default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Curie' default when unset). */

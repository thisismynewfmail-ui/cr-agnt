...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    curie_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__curie_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Curie-Session-Token":
              (window as unknown as { __CURIE_SESSION_TOKEN__?: string })
                .__CURIE_SESSION_TOKEN__ ?? "",
          },
        });

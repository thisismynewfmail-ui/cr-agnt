...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateCurie: string;
    updateCurieConfirmMessage?: string;
    updateCurieConfirmNow?: string;
    updateCurieConfirmTitle?: string;
    updatingCurie: string;
  ...
  // ── Achievements plugin (plugins/curie-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;

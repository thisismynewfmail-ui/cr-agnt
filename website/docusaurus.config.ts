...
const config: Config = {
  ...
  url: 'https://github.com/thisismynewfmail-ui/Cur-Agnt',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'curie-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-curie-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/thisismynewfmail-ui/Cur-Agnt/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/curie-agent-banner.png',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/thisismynewfmail-ui/Cur-Agnt/',
          label: 'Download',
          position: 'left',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/thisismynewfmail-ui/Cur-Agnt/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://github.com/thisismynewfmail-ui/Cur-Agnt/' },
            { label: 'GitHub', href: 'https://github.com/thisismynewfmail-ui/Cur-Agnt' },

...
| [`curie-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-curie-agent) | Use, configure, theme, extend, and orchestrate Curie Agent. | `autonomous-ai-agents\curie-agent` |
...
| [`curie-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-curie-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\curie-agent-skill-authoring` |
| [`inspecting-curie-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-curie-desktop-dom) | Read the live Curie desktop DOM/CSS over CDP. | `software-development\inspecting-curie-desktop-dom` |

...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/health/neuroskill-bci` |
...
Connect Curie to a running [NeuroSkill](https://neuroskill.com/) instance to read

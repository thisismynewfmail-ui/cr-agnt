...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/mlops/lambda-labs` |
...
- **[Advanced Usage](https://github.com/thisismynewfmail-ui/Cur-Agnt/blob/main/optional-skills/mlops\lambda-labs/references/advanced-usage.md)** - Multi-node training, API automation
- **[Troubleshooting](https://github.com/thisismynewfmail-ui/Cur-Agnt/blob/main/optional-skills/mlops\lambda-labs/references/troubleshooting.md)** - Common issues and solutions

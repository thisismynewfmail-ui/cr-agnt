...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`curie-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-curie-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Curie Agent via the native MCP client. This is the preferred
...
Then configure Curie Agent to connect via HTTP:

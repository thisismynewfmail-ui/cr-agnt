...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Curie Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $CURIE_OSINT_CACHE/icij/ (default: ~/.cache/curie-osint/icij/).
...
# Set CURIE_OSINT_UA=your-app/1.0 (your@email) to identify yourself

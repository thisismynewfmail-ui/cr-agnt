...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/research/blogwatcher` |
...
## Working with Curie tools (read this first)

`blogwatcher-cli` is the feed database; Curie tools do the automation around it:

...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/web-development/page-agent` |
...
- User wants **Curie itself to drive a browser** → use Curie' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.

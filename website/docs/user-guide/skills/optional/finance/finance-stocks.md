...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Curie Agent |
| License | MIT |
...
```
SCRIPT=~/.curie/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.curie/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```

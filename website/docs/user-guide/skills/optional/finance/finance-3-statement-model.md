...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/finance/3-statement-model` |
...
See [references/formulas.md](https://github.com/thisismynewfmail-ui/Cur-Agnt/blob/main/optional-skills/finance\3-statement-model/references/formulas.md) for all formula details.

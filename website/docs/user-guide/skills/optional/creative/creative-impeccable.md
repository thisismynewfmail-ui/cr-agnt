...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/creative/impeccable` |
...
> ships and verifies a Curie-native skill bundle under `.curie/skills/`.
> `curie skills install impeccable` pulls the current bundle live from that

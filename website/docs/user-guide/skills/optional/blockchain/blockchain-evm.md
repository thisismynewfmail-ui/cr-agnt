...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain\evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Curie Agent |
| License | MIT |
...
Helper script path: `~/.curie/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.curie/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.curie/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.curie/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```

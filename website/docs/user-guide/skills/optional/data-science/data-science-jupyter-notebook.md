...
| | |
|---|---|
| Source | Optional — install with `curie skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing curie tool access (web_search, file ops). Stateless. |

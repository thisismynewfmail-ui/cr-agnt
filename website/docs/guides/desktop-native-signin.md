...
description: "How the Curie Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Curie Desktop app connects to a **gated gateway** (a hosted or
...
For Curie specifically, native sign-in means:
...
- [Run Curie with Nous Portal](./run-curie-with-nous-portal.md)

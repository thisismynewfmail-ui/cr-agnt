...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `curie_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `curie_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Curie Plugin](plugins/index.md) |
...
| Session storage | `curie_state.py` | [Session Storage](session-storage.md) |

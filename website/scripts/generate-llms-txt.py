#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Curie docs site.
...
LLM reads to learn what Curie does.
...
SITE_BASE = "https://github.com/thisismynewfmail-ui/Cur-Agnt/tree/main/website/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Core Features", [
        ...
        ("user-guide/features/soul", "SOUL.md — the agent's voice", None),
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Curie as a Python Library", None),
        ("guides/use-mcp-with-curie", "Use MCP with Curie", None),
        ("guides/use-voice-mode-with-curie", "Use Voice Mode with Curie", None),
        ("guides/use-soul-with-curie", "Use SOUL.md with Curie", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Curie"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "curie-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/thisismynewfmail-ui/Cur-Agnt")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Curie Agent — Full Documentation\n",
        (
            "This file is the entire Curie Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Curie, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://github.com/thisismynewfmail-ui/Cur-Agnt/tree/main/website/docs\n",
        "Short index: https://github.com/thisismynewfmail-ui/Cur-Agnt/tree/main/website/docs\n",
        "\n---\n\n",
    ]

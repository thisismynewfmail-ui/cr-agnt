...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Curie gateway adapter.

    Each inbound phone number gets its own Curie session (multi-tenant).
...
# static dict in curie_cli/gateway.py, and the _send_sms dispatch in

...
Config: ~/.curie/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.curie/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_curie_home()`` helper (CURIE_HOME-aware and
...
RULES_FILE = get_curie_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_curie_home() / "feishu_comment_pairing.json"

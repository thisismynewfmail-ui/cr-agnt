...
required — uses aiohttp which is already a Curie dependency.
...
def interactive_setup() -> None:
    ...
    ``curie_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Curie delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # curie_cli/setup.py::_setup_mattermost function.

...
Configuration
-------------
Secret (lives in $CURIE_HOME/.env or the environment):
...
Behavioral settings (live in $CURIE_HOME/mem0.json, set via `curie memory
setup`):
  ...
  agent_id           — Agent identifier (default: curie)
...
def _load_config() -> dict:
    """Load config from env vars, with $CURIE_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "curie"),
        "oss": {},
    }
    ...
    config_path = get_curie_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, curie_home):
        """Write config to $CURIE_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $CURIE_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "curie")

...
# When the user hasn't picked a reasoning effort, Curie passes
...
# ON at this effort — matching the "medium (default)" that Curie' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Curie' effort vocabulary onto Solar's accepted set via the

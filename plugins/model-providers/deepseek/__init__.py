...
the contract that subsequent turns echo it back; combined with how Curie
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Curie remaps
the retired IDs in ``curie_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Curie, so they are not listed here.
    """

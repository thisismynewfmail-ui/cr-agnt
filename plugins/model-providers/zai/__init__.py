...
request omits ``thinking``.  Curie' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Curie reasoning
...
(per Z.AI / BigModel docs).  Curie' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Curie reasoning effort onto GLM's native vocabulary.

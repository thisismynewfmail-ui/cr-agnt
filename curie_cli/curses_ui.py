"""Shared curses-based UI components for Curie CLI.

Used by `curie tools` and `curie skills` for interactive checklists.
...
_MENU_NAVIGATION_HANDLER: ContextVar[MenuNavigationHandler | None] = ContextVar(
    "curie_menu_navigation_handler", default=None
)
_NUMBERED_BACK_ENABLED: ContextVar[bool] = ContextVar(
    "curie_numbered_back_enabled", default=False
)

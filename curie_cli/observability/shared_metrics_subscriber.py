"""Relay subscriber for the persisted Curie shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Curie counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Curie shared metric: %s",
                    metric_name,
                    exc_info=True,
                )

...
session reaches the edge of its granted window, Curie grows the window
...
new window and re-prefills the conversation. Nothing about the Curie
...
def maybe_grow_window(model_id: str, *, base_url: str, session_tokens: int,
    ...
    from curie_cli.local_runtime.estimator import profile_from_gguf
    from curie_cli.local_runtime.gguf import read_gguf_header

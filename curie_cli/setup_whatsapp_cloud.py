...
Entry point: ``curie whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``curie_cli/main.py``).
...
Curie gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Curie to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Curie needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Curie gateway in another terminal:")
    print("         curie gateway")
    print()
    ...
    print()
    print("  Docs: https://github.com/thisismynewfmail-ui/Cur-Agnt/tree/main/website/docs/user-guide")

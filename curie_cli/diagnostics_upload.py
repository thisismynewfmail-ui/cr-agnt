"""Client for uploading ``curie debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``curie debug share``.
...
NAS_BASE = os.environ.get(
    "CURIE_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "curie-agent/debug-share"

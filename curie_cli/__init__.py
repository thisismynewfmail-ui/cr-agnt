"""
Curie CLI - Unified command-line interface for Curie Agent.

Provides subcommands for:
- curie chat          - Interactive chat (same as ./curie)
- curie gateway       - Run gateway in foreground
- curie gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `curie setup` on a fresh Pi.
    ...
    curie_cli/stdio.py::configure_windows_stdio() runs later from the entry

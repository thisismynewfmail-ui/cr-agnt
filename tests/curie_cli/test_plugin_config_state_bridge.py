...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\Curie 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\Curie 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\Curie 🚀"
...
"""
    env = dict(os.environ, CURIE_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(

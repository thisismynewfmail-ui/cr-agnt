"""Tests for the shared byte formatter (curie_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from curie_cli.backup import _format_size as backup
    from curie_cli.checkpoints import _fmt_bytes as checkpoints
    from curie_cli.doctor import _human_bytes as doctor

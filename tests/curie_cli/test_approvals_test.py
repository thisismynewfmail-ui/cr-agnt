"""Tests for ``curie approvals test`` — dry-run approval verdict CLI.
...
from curie_cli import approvals_test as at
...
def isolated_approvals(monkeypatch):
    ...
    monkeypatch.setattr(A, "is_current_session_unlock_enabled", lambda: False)

"""Tests for the specifier module + `curie kanban specify` CLI surface.
...
from curie_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `curie kanban …` argparse surface directly."""

...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (curie_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_curie_overlays():
    """curie_cli.providers.get_provider("vertex") backs

...
The main() function in curie_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `curie -c model`
...
def _build_parser():
    """Build a minimal replica of the curie top-level parser."""

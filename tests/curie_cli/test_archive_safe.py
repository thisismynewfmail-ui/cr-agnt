"""Tests for the shared tar.gz writer (``curie_cli.archive_safe.make_targz``).

``make_targz`` backs both ``curie profile export`` and ``curie kanban
...
from curie_cli.archive_safe import make_targz

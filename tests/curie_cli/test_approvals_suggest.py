"""Tests for ``curie approvals suggest`` (curie_cli/approvals_suggest.py).

Approval history in Curie is implied, not ledgered: the session DB
...
from curie_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,

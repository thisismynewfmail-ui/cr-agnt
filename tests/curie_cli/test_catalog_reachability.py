...
Run before any catalog commit:
    ...
    CURIE_TEST_NETWORK=1 scripts/run_tests.sh tests/curie_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("CURIE_TEST_NETWORK"),
    reason="network test; set CURIE_TEST_NETWORK=1 to run",
)

...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`curie_cli.slash_exec.EXECUTORS`, and
...
from curie_cli.commands import COMMAND_REGISTRY, resolve_command
from curie_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,

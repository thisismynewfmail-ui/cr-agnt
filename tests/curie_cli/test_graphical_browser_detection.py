"""Tests for `_can_open_graphical_browser()` in curie_cli.auth.

Guards the fix for the May 2026 report where `curie auth add xai-oauth`
...
from curie_cli.auth import _can_open_graphical_browser

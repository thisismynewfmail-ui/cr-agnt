"""Tests for the ``curie prompt-size`` diagnostic (issue #34667)."""
...
from curie_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(curie_home, memory_text="", user_text=""):
    mem_dir = curie_home / "memories"
...
def _seed_skill(curie_home, name, description):
    skill_dir = curie_home / "skills" / "demo" / name

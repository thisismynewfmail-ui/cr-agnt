"""Tests for `curie secrets bitwarden token` / `curie secrets onepassword token`.
...
from curie_cli import onepassword_secrets_cli as op_cli
from curie_cli import secrets_cli as bw_cli

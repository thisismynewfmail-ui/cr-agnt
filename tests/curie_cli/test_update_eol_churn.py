"""Regression: ``curie update`` should take a managed checkout off autocrlf=true.
...
``curie update`` has to repair them.
...
from curie_cli.update_cmd import _normalize_managed_eol

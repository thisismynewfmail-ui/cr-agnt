...
from curie_cli.dashboard_auth import clear_providers, list_providers
from curie_cli.plugins import PluginManager, discover_plugins
...
class TestBasicProviderLoadsAfterUnblock:
    def test_disabled_basic_blocks_registration(self, curie_home, monkeypatch):

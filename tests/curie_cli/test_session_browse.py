"""Tests for the interactive session browser (`curie sessions browse`).
...
from curie_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """curie sessions browse should be parseable."""

...
class TestGetCopilotModelContext:
    ...
    @patch("curie_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("curie_cli.models._urlopen_model_catalog_request")
    ...
    @patch("curie_cli.models.fetch_github_model_catalog", return_value=[])

"""Tests for `curie chat --safe-mode` isolation."""
...
_VARS = ("CURIE_SAFE_MODE", "CURIE_IGNORE_USER_CONFIG", "CURIE_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["CURIE_SAFE_MODE"] == "1"
        assert os.environ["CURIE_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["CURIE_IGNORE_RULES"] == "1"
        return True

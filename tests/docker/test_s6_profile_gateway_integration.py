...
The unit tests in tests/curie_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned curie-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/curie")
from curie_cli.service_manager import S6ServiceManager

...
from curie_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/curie_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("curie_cli.lifecycle.invoke_hook")
@patch("curie_cli.lifecycle.finalize_session")

...
Keeps the ACP server tests offline: ``CurieACPAgent._build_model_state``
calls ``curie_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import curie_cli.inventory as inventory

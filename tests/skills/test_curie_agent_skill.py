"""The `curie-agent` skill is what a running Curie knows about itself.

`website/` is never packaged, so an installed Curie has no local copy of the
user guide; skills ARE synced into `$CURIE_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Curie can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "curie-agent"

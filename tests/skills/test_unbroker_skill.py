...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and curie-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # curie-agent (tests/skills/)
]

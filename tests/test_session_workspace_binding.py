"""Session <-> workspace grouping key (curie_state.workspace_key).

The key is what `curie sessions list --workspace` groups/filters on. It is a
...
from curie_state import workspace_key

...
def _clear_approval_state():
    ...
    approval_mod._session_unlock.clear()
...
def test_clear_session_boundary_security_state_is_scoped():
    """The helper must wipe only the target session's approval/unlock state.
    ...
    enable_session_unlock(other_key)
    ...
    assert is_session_unlock_enabled(session_key) is False
    ...
    assert is_session_unlock_enabled(other_key) is True

...
def store(tmp_path, monkeypatch):
    ...
    ~/.curie/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at curie_state import time, before pytest's CURIE_HOME monkeypatch
    fires — the autouse fixture's CURIE_HOME override doesn't help here.)
    """
    import curie_state

"""Tests for _setup_feishu() in curie_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("curie_cli.config.save_env_value", side_effect=mock_save), \
         patch("curie_cli.config.get_env_value", side_effect=mock_get), \
         patch("curie_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("curie_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("curie_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("curie_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("curie_cli.cli_output.print_header"), \
         patch("curie_cli.cli_output.print_info"), \
         patch("curie_cli.cli_output.print_success"), \
         patch("curie_cli.cli_output.print_warning"), \
         patch("curie_cli.cli_output.print_error"), \

...
thinking phase.  Curie's default cloud-stream stale detector
(``CURIE_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``CURIE_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the

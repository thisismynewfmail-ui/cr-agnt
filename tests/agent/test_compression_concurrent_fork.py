...
Damien's incident (Discord, 2026-05-28): a long Curie session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``curie_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "curie_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "curie_state"

...
def make_curie_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated CURIE_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"curie-home-{journal_mode}"

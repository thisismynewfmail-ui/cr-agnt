"""Regression test: curie update must not load cryptography eagerly."""
...
assert 'curie_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running curie update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so curie_cli is importable,
...
import curie_cli.main
from curie_cli.update_cmd import _cmd_update_check

 ...
 *
 * Each entry is a key/value pair that lands in the packaged Curie.app's
 ...
 * "Curie wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Curie wants to access Music" when Curie never touches the Music
